...
import cc.fascinated.fascinatedutils.systems.hud.ItemRowHostHudPanel;
...
public class ItemRowHudPanel extends ItemRowHudModule {
    ...
    private ItemRowHudPanel(String widgetId, String displayName, float minWidth, Function<Float, List<HudContent.ItemRow>> contentProvider, Function<Float, List<HudContent.ItemRow>> editorPreviewProvider) {
        super(widgetId, displayName, minWidth);
        this.contentProvider = contentProvider;
        this.editorPreviewProvider = editorPreviewProvider;
        registerHudPanel(new ItemRowHostHudPanel(this, widgetId, minWidth));
    }
    ...
    public static class Builder {
        ...
        public ItemRowHudPanel build() {
            ...
            ItemRowHudPanel panel = new ItemRowHudPanel(widgetId, displayName, minWidth, contentProvider, editorPreviewProvider);
