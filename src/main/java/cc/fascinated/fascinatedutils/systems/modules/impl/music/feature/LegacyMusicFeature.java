...
public class LegacyMusicFeature extends Feature<MusicModule> {
     ...
     */
    private static final Set<String> LEGACY_VANILLA_MUSIC_STREAM_PATHS = Set.of("music/game/clark", "music/game/creative/aria_math", "music/game/creative/biome_fest", "music/game/creative/blind_spots", "music/game/creative/dreiton", "music/game/creative/haunt_muskie", "music/game/creative/taswell", "music/game/danny", "music/game/dry_hands", "music/game/end/alpha", "music/game/end/boss", "music/game/end/the_end", "music/game/haggstrom", "music/game/key", "music/game/living_mice", "music/game/mice_on_venus", "music/game/minecraft", "music/game/nether/ballad_of_the_cats", "music/game/nether/concrete_halls", "music/game/nether/dead_voxel", "music/game/nether/warmth", "music/game/oxygene", "music/game/subwoofer_lullaby", "music/game/sweden", "music/game/water/axolotl", "music/game/water/dragon_fish", "music/game/water/shuniji", "music/game/wet_hands", "music/menu/beginning_2", "music/menu/floating_trees", "music/menu/moog_city_2", "music/menu/mutation");

    private final BooleanSetting legacyMusicOnly = BooleanSetting.builder().id("legacy_music_only").defaultValue(false).build();
    ...
    private static boolean isVanillaGlobalMusicSoundPath(String path) {
        return switch (path) {
            case "music.menu", "music.game", "music.creative", "music.credits", "music.end", "music.dragon",
    ...
    public boolean isVanillaGlobalMusicChannel(Holder<SoundEvent> sound) {
        return sound.unwrapKey().map(ResourceKey::identifier).filter(identifier -> Identifier.DEFAULT_NAMESPACE.equals(identifier.getNamespace())).map(Identifier::getPath).filter(LegacyMusicFeature::isVanillaGlobalMusicSoundPath).isPresent();
    }
