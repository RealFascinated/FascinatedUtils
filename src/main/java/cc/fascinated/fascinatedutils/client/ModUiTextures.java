...
public enum ModUiTextures {
    CLOSE("textures/ui/mod_settings/close.png", 64, 64), BACK("textures/ui/mod_settings/back.png", 64, 64), RESET("textures/ui/mod_settings/reset.png", 64, 64), TRASH("textures/ui/mod_settings/trash.png", 64, 64), CHECK("textures/ui/mod_settings/check.png", 64, 64), SETTINGS("textures/ui/mod_settings/settings.png", 64, 64), CHEVRON_DOWN("textures/ui/mod_settings/keyboard_arrow_down.png", 64, 64), CHEVRON_RIGHT("textures/ui/mod_settings/keyboard_arrow_right.png", 64, 64);
