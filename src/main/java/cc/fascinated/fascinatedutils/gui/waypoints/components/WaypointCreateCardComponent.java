...
public class WaypointCreateCardComponent {
    ...
    public static FWidget build(String dimension, SettingColor color, FOutlinedTextInputWidget nameInput,
        ...
        FButtonWidget confirmButton = new FButtonWidget(onSubmit,
                () -> Component.translatable("alumite.waypoints.create.confirm").getString(), 100f, 1, 1f, 8f, 1f, 8f, -1f);
        ...
        body.addChild(sectionLabel(Component.translatable("alumite.waypoints.create.title").getString(), true, FascinatedGuiTheme.INSTANCE.textPrimary()));
