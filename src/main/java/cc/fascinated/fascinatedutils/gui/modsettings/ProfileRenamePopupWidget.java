...
public class ProfileRenamePopupWidget extends FPopupWidget {
    ...
    public ProfileRenamePopupWidget(String currentName, Runnable onCancel, SubmitRenameCallback onSubmit) {
        super(onCancel);
