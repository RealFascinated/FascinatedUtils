...
public final class ModSettingsModulesPresentationComponent extends UiComponent<ModSettingsModulesPresentationComponent.Props> {
    ...
    public UiView render() {
        ...
        return Ui.custom(previousWidget -> {
            ...
            if (!(nextSurface instanceof PresentationSurface surface)) {
                throw new IllegalStateException("composeModulesPresentationSurface must return PresentationSurface");
            }
