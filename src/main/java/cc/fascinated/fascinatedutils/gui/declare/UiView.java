 ...
 */
public sealed interface UiView permits UiView.UiColumn, UiView.UiRow, UiView.UiStack, UiView.UiScroll, UiView.UiSpacer, UiView.UiMinWidth, UiView.UiMaxCenter, UiView.UiRect, UiView.UiLabel, UiView.UiButton, UiView.UiOutlinedPinned, UiView.UiCustom, UiView.UiWidgetSlot, UiView.UiComponentNode {
    ...
    record ButtonSpec(Runnable onClick, Supplier<String> label, float layoutWidthLogical, int maxLabelLines,
                      float labelLineGapDesign, float verticalPadDesign, float heightScale,
                      float horizontalTextPadDesign, float cornerRadiusDesign) {}
    ...
    record UiMaxCenter(float insetHorizontal, float insetVertical, float maxWidth, float maxHeight,
                       UiView inner) implements UiView {}
     ...
     */
    record UiComponentNode<P>(Class<? extends UiComponent<P>> type, Supplier<? extends UiComponent<P>> factory,
