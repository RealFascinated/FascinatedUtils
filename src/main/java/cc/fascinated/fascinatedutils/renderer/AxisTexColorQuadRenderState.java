...
public class AxisTexColorQuadRenderState implements GuiElementRenderState {
    ...
    /**
     * @param pipeline         typically {@link FascinatedUiPipelines#AXIS_TEX_COLOR}
     * @param textureSetup     opaque white (or neutral) texture setup
     ...
     */
    public AxisTexColorQuadRenderState(RenderPipeline pipeline, TextureSetup textureSetup, Matrix3x2f pose, int x0, int y0, int x1, int y1, int colorTopLeft, int colorBottomLeft, int colorBottomRight, int colorTopRight, ScreenRectangle scissorArea) {
