...
import cc.fascinated.fascinatedutils.oldgui.hudeditor.HudEditorChrome;
import cc.fascinated.fascinatedutils.oldgui.hudeditor.HudEditorOverlays;
import cc.fascinated.fascinatedutils.oldgui.hudeditor.HudEditorPointerSession;
...
public class HUDEditorScreen extends WidgetScreen {
    ...
    private final FadeInAnim screenAnim = new FadeInAnim(200f);
