...
import cc.fascinated.fascinatedutils.oldgui.waypoints.components.WaypointCreateCardComponent;
            ...
            public void layout(UIRenderer measure, float lx, float ly, float lw, float lh) {
                ...
                if (Math.abs(lw - lastWidth) > 0.5f || Math.abs(lh - lastHeight) > 0.5f
                    ...
                    addChild(new FMaxCenterInsetsWidget(40f, 40f, cardWidth, innerMaxHeight,
                            WaypointCreateCardComponent.build(dimension, color, nameInput, xInput, yInput, zInput,
                                    WaypointCreateScreen.this::openColorPicker,
                                    () -> Minecraft.getInstance().setScreen(null),
                                    WaypointCreateScreen.this::create)));
