package cc.fascinated.fascinatedutils.oldgui.themes;
...
public class FascinatedGuiTheme extends GuiTheme {
    ...
    private static final int TOGGLE_ON_FILL = UiColor.argb("#CC1e7a50");
    private static final int TOGGLE_ON_BORDER = UiColor.argb("#AA33aa70");
    private static final int TOGGLE_ON_FILL_HOVER = UiColor.argb("#DD258a5a");
    private static final int TOGGLE_OFF_FILL = UiColor.argb("#BB28151e");
    private static final int TOGGLE_OFF_BORDER = UiColor.argb("#994a2535");
    private static final int TOGGLE_OFF_FILL_HOVER = UiColor.argb("#CC351f2a");
    private static final int TOGGLE_OFF_BORDER_HOVER = UiColor.argb("#BB6a3548");
