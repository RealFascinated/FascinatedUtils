...
public class SendScreenshotPopupNode extends PopupNode {
    ...
    public SendScreenshotPopupNode(Screenshot screenshot, Runnable onDismiss) {
        ...
        TextNode titleNode = new TextNode("Send Screenshot");
        ...
        if (Alumite.INSTANCE == null) {
            TextNode disconnectedLabel = new TextNode("Not connected");
        ...
        listArea.fullWidth().top(listTop).bottom(PAD);
        listArea.addChild(friendList);

        if (friends == null || friends.isEmpty()) {
            TextNode emptyLabel = new TextNode("No friends");
